...
data.drop(['mass_wrt_earth', 'mass_multiplier', 'mass_wrt', 'radius_multiplier', 'mass_wrt', 'distance', 'stellar_magnitude', 'orbital_radius', 'orbital_period','star_mass'],  inplace=True, axis=1)
data = data.reindex(columns=['radius_wrt_earth', 'planet_type'])
print(data.head())
...
dump(st, 'std_scaler2.bin', compress=True)
